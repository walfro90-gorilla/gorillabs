...
import { getAllProjects, getProjectsByCategory, type Project } from "@/lib/portfolio"
...
export default function PortfolioPage() {
  ...
  const handleProjectClick = (project: Project) => {
    ...
    // Store project data in localStorage for the detail page
                ...
                {selectedProject.gallery.map((img, index) => (
                  <div key={index} className="relative aspect-video w-full overflow-hidden rounded-lg">
                    <Image
                      ...
                      alt={`${selectedProject.title} - Galería ${index + 1}`}
                      fill
                      className="object-cover"
                    />
                  </div>
